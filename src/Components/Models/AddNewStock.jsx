        ...
        <Modal open={open} onClose={handleClose}>
            <Box sx={style}>
                ...
                <Box sx={{ display: "flex", gap: "30px", mt: 3 }}>
                    <Typography><strong>Product:</strong> {productName}</Typography>
                    <Typography><strong>Supplier:</strong> {supplier}</Typography>
                    <Typography><strong>Rack No:</strong> {rackNo}</Typography>
                </Box>
